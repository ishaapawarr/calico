const styles = {
  ...
  hero2Heading:
      'font-italic text-[24px] lg:text-[48px] md:text-[48px] sm:text-[36px] lg:leading-[64px] md:leading-[48px] sm:leading-[36px] leading-[24px] uppercase text-white mb-[30px]',
};
